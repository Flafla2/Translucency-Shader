...
{
internal class StandardTranslucentShaderGUI : ShaderGUI
{
    ...
    MaterialProperty transPower = null;
	...
	public void FindProperties (MaterialProperty[] props)
	{
        ...
        thicknessMap = FindProperty("_Thickness", props);
        transPower = FindProperty("_TranslucentPower", props);
        distortion = FindProperty("_TranslucentDistortion", props);
	}
	...
	public void ShaderPropertiesGUI (Material material)
	{
		...
		EditorGUI.BeginChangeCheck();
		{
            ...
            m_MaterialEditor.RangeProperty(transPower, "Translucency Power");
            m_MaterialEditor.RangeProperty(distortion, "Translucency Distortion");
